                ...
                <div className={cx("content-wrapper")}>
                    <div className={cx("contact-info-warpper")}>
                        <div className={cx("contact-detail")}>
                            ...
                            <div className={cx("contact-detail-content")}>Contrary to popular belief, Lorem Ipsum is simply random text. It has roots in a piece of classical Latin literature from 45 BC, maki years old.</div>
                        </div>
                        <div className={cx("card-item-wrapper")}>
                            <div className={cx("card-item")}>
                                <div className={cx("card-item-icon-wrapper")}><SlLocationPin className={cx("card-item-icon")}/></div>
                                <div className={cx("card-item-content-wrapper")}>
                                    <div className={cx("card-item-title")}>Address:</div>
                                    <div className={cx("card-item-content")}>Gốc Đề, Minh khai, Hai Bà Trưng, Hà Nội</div>
                                </div>
                            </div>
                            <div className={cx("card-item")}>
                                <div className={cx("card-item-icon-wrapper")}><TfiMobile className={cx("card-item-icon")}/></div>
                                <div className={cx("card-item-content-wrapper")}>
                                    <div className={cx("card-item-title")}>Phone:</div>
                                    <div className={cx("card-item-content")}>+65 11.188.888</div>
                                </div>
                            </div>
                            <div className={cx("card-item")}>
                                <div className={cx("card-item-icon-wrapper")}><TfiEmail className={cx("card-item-icon")}/></div>
                                <div className={cx("card-item-content-wrapper")}>
                    ...
                    <div className={cx("right-content-wrapper")}>
                        <div className={cx("contact-detail")}>
                            ...
                            <div className={cx("contact-detail-content")}>Our staff will call back later and answer your questions.</div>
                        </div>
                        <form className={cx("form-wrapper")}>
                                ...
                                <button type="submit" className={cx("send-btn")} >Send message</button>
                        </form>
                    </div>
                </div>
            </div>
